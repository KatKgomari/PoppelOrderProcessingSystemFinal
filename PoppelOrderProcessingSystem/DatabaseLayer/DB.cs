...
using PoppelOrderProcessingSystem.Properties;
...
namespace PoppelOrderProcessingSystem.DatabaseLayer
{
    public class DB
    {
        ...
        private string strConn = Settings.Default.PoppelDatabaseConnectionString; // Connnection String
        ...
        public enum DBOperation 
        {
            Add = 0,
            Edit = 1,
            Delete = 2 // Decide later whether we want to be able to delete an order or a customer
        }
        #endregion
        ...
        #region Fills dataset fresh from the db for a specific table and with a specific Query    //THIS WORKS WELL     
